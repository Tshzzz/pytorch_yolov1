...
from yolov1.encoder import yolo_encoder
from yolov1.decoder import yolo_decoder
...
def test_encoder_decoder():
    ...
    for meta in tqdm(load):
        ...
        #scale_gt.resize((meta['img_width']//4,meta['img_height']//4))

        target = yolo_encoder(scale_gt,7,2,20)
